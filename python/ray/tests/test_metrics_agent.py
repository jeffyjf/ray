...
def _setup_cluster_for_test(request, ray_start_cluster):
    ...
    cluster.add_node(
        _system_config={
            ...
            "experimental_enable_open_telemetry_on_agent": os.environ.get(
                "RAY_experimental_enable_open_telemetry_on_agent", "0"
            ),
            "experimental_enable_open_telemetry_on_core": os.environ.get(
                "RAY_experimental_enable_open_telemetry_on_core", "0"
            ),
        }
    )
    # Add worker nodes.
